# 🏥 AccrediX — Portail d'Auto-Évaluation GRI (INEAS)

**AccrediX** est une plateforme web d'évaluation et de pilotage de la **Gestion des Risques Infectieux (GRI)** conçue pour l'**INEAS** (Instance Nationale d'Évaluation et d'Accréditation en Santé).

Elle permet aux établissements de santé (hôpitaux publics, CHU, cliniques privées) de réaliser leur auto-évaluation sur les critères officiels de l'INEAS, de soumettre leurs preuves documentaires, de bénéficier d'une assistance intelligente propulsée par IA (Groq), et permet à l'INEAS de superviser l'état d'avancement national en temps réel.
...
│   ├── admin.html          # Dashboard national de supervision INEAS (Administrateur)
...
│   └── 📂 assets/
│       └── logo_ineas.png  # Logo officiel de l'INEAS
│
...
| `h3` | `hospitalpass3` | Hôpital Militaire Principal (HMPIT) | Tunis (Hôpital Militaire) |
...
3. **Plateforme d'Auto-Évaluation GRI (`/index.html`)** :
   ...
   - Fil de discussion direct entre l'hôpital et les évaluateurs INEAS.
   - **Rapport Officiel d'Accréditation INEAS** : Générateur de document officiel au format ministériel A4 (en-tête République Tunisienne/INEAS, logo officiel, matrice des 9 références, synthèses détaillées, analyse stratégique, conclusions institutionnelles avec recommandations, et doubles cadres de signatures/cachets).
4. **Dashboard Superviseur INEAS (`/admin.html`)** :
...
- **Frontend** : HTML5, CSS moderne avec design épuré conforme à l'identité visuelle de l'INEAS, Vanilla JavaScript interactif.
